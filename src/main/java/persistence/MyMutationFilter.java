...
public class MyMutationFilter {
    ...
    /**
     * Construct a MutationFilter with no white lists. This filter will
     * <br>
     * REJECT Silent, LOH, Intron and Wildtype mutations, and
     * <br>
     * KEEP all other mutations.
     */
    public MyMutationFilter() throws IllegalArgumentException {
    ...
    /**
     * Provide number of ACCEPT (return true) decisions made by this
     * MutationFilter.
     *
     * @return the number of ACCEPT (return true) decisions made by this
     * MutationFilter
     */
    ...
    /**
     * Provide number of germline whitelist ACCEPT (return true) decisions made
     * by this MutationFilter.
     *
     * @return the number of germline whitelist ACCEPT (return true) decisions
     * made by this MutationFilter
     */
    ...
    /**
     * Provide number of somatic whitelist ACCEPT (return true) decisions made
     * by this MutationFilter.
     *
     * @return the number of somatic whitelist ACCEPT (return true) decisions
     * made by this MutationFilter
     */
    ...
    /**
     * Provide number of unknown whitelist ACCEPT (return true) decisions made
     * by this MutationFilter.
     *
     * @return the number of unknown ACCEPT (return true) decisions made by this
     * MutationFilter
     */
    ...
    /**
     * Provide number of REJECT (return false) decisions made by this
     * MutationFilter.
     *
     * @return the number of REJECT (return false) decisions made by this
     * MutationFilter
     */
     ...
     * @param data
     * @param pattern
     * @return false if data is null; true if data starts with pattern,
     * independent of case
     */
