...
public final class MyDaoClinicalData {
    ...
    private static void cacheAttributes(String table, Map<String, String> cache) {
        ...
        ResultSet rs = null;
        try {
            con = JdbcUtil.getDbConnection(MyDaoClinicalData.class);
            ...
            JdbcUtil.closeAll(MyDaoClinicalData.class, con, pstmt, rs);
        }
    }

    public static int addSampleDatum(int internalSampleId, String attrId, String attrVal) throws SQLException {
        sampleAttributes.put(attrId, attrId);
        return addDatum(SAMPLE_INSERT, SAMPLE_TABLE, internalSampleId, attrId, attrVal);
    }

    public static int addPatientDatum(int internalPatientId, String attrId, String attrVal) throws SQLException {
    ...
    public static int addDatum(String query, String tableName,
            int internalId, String attrId, String attrVal) throws SQLException {
    ...
    public static ClinicalData getDatum(String cancerStudyId, String patientId, String attrId) throws SQLException {
    ...
    private static int getInternalCancerStudyId(String cancerStudyId) throws SQLException {
        return DaoCancerStudy.getCancerStudyByStableId(cancerStudyId).getInternalId();
    }

    private static String getAttributeTable(String attrId) throws SQLException {
    ...
    private static ClinicalData getDatum(int internalCancerStudyId, String table, int internalId, String attrId) throws SQLException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public static List<ClinicalData> getDataByPatientId(Connection con, int cancerStudyId, String patientId) throws SQLException {
        List<Integer> internalIds = new ArrayList<>();
        internalIds.add(DaoPatient.getPatientByCancerStudyAndPatientId(con, cancerStudyId, patientId).getInternalId());
        return getDataByInternalIds(con, cancerStudyId, PATIENT_TABLE, internalIds);
    }

    private static List<ClinicalData> getDataByInternalIds(Connection con, int internalCancerStudyId, String table, List<Integer> internalIds) throws SQLException {
        System.out.println(">getDataByInternalIds: ");
    ...
    public static List<ClinicalData> getDataByPatientId(int cancerStudyId, String patientId) throws SQLException {
        List<Integer> internalIds = new ArrayList<>();
    ...
    private static List<ClinicalData> getDataByInternalIds(int internalCancerStudyId, String table, List<Integer> internalIds) throws SQLException {
        System.out.println(">getDataByInternalIds: internalCancerStudyId=" + internalCancerStudyId + "; table=" + table + "; internalIds=" + internalIds);
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            rs = pstmt.executeQuery();
            while (rs.next()) {
                clinicals.add(extract(con, table, internalCancerStudyId, rs));
            }
        } catch (SQLException e) {
            throw new SQLException(e);
        } finally {
    ...
    public static List<ClinicalData> getData(String cancerStudyId) throws SQLException {
        return getData(getInternalCancerStudyId(cancerStudyId));
    }

    public static List<ClinicalData> getData(int cancerStudyId) throws SQLException {
    ...
    public static List<ClinicalData> getData(String cancerStudyId, Collection<String> patientIds) throws SQLException {
        return getData(getInternalCancerStudyId(cancerStudyId), patientIds);
    }

    public static List<ClinicalData> getData(int cancerStudyId, Collection<String> patientIds) throws SQLException {
    ...
    public static List<ClinicalData> getSampleAndPatientData(int cancerStudyId, Collection<String> sampleIds) throws SQLException {
    ...
    public static List<ClinicalData> getSampleAndPatientData(int cancerStudyId, Collection<String> sampleIds, ClinicalAttribute attr) throws SQLException {
        List<Integer> sampleIdsInt = new ArrayList<Integer>();
        List<Integer> patientIdsInt = new ArrayList<Integer>();
        Map<String, Set<String>> mapPatientIdSampleIds = new HashMap<String, Set<String>>();
        for (String sampleId : sampleIds) {
    ...
    public static List<ClinicalData> getSampleData(int cancerStudyId, Collection<String> sampleIds, ClinicalAttribute attr) throws SQLException {
        List<Integer> sampleIdsInt = new ArrayList<Integer>();
        for (String sampleId : sampleIds) {
    ...
    public static List<ClinicalData> getSampleData(int cancerStudyId, Collection<String> sampleIds) throws SQLException {
        System.out.println(">getSampleData: cancerStudyId=" + cancerStudyId + "; sampleIds=" + sampleIds);
        List<Integer> sampleIdsInt = new ArrayList<>();
        for (String sampleId : sampleIds) {
            sampleIdsInt.add(DaoSample.getSampleByCancerStudyAndSampleId(cancerStudyId, sampleId).getInternalId());
        }
    ...
    public static List<ClinicalData> getData(String cancerStudyId, Collection<String> patientIds, ClinicalAttribute attr) throws SQLException {
        int internalCancerStudyId = getInternalCancerStudyId(cancerStudyId);
        List<Integer> patientIdsInt = new ArrayList<Integer>();
        for (String patientId : patientIds) {
    ...
    private static List<ClinicalData> getDataByInternalIds(int internalCancerStudyId, String table, List<Integer> internalIds, Collection<String> attributeIds) throws SQLException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public static List<ClinicalData> getDataByAttributeIds(int internalCancerStudyId, Collection<String> attributeIds) throws SQLException {
    ...
    private static ClinicalData extract(Connection con, String table, int internalCancerStudyId, ResultSet rs) throws SQLException {
        // get 
        String stableId = getStableIdFromInternalId(con, table, rs.getInt("INTERNAL_ID"));
        return new ClinicalData(internalCancerStudyId,
                stableId,
                rs.getString("ATTR_ID"),
                rs.getString("ATTR_VALUE"));
    ...
    private static String getStableIdFromInternalId(Connection con, String table, int internalId) throws SQLException {
        System.out.println(">getStableIdFromInternalId1: table=" + table + "; internalId=" + internalId);
        if (table.equals(SAMPLE_TABLE)) {
            return DaoSample.getSampleById(con, internalId).getStableId();
        } else {
            return DaoPatient.getPatientById(con, internalId).getStableId();
        }
    }

    private static String getStableIdFromInternalId(String table, int internalId) throws SQLException {
        System.out.println(">getStableIdFromInternalId2: table=" + table + "; internalId=" + internalId);
        if (table.equals(SAMPLE_TABLE)) {
     ...
     */
    /**
     * Returns the survival data for the given patientSet, NOT necessarily in
     * the same order as the patientSet.
     *
     ...
     * @throws SQLException
     */
    public static List<Patient> getSurvivalData(int cancerStudyId, Collection<String> patientSet) throws SQLException {
     ...
     * ***********************************************************
     */
    public static List<ClinicalParameterMap> getDataSlice(int cancerStudyId, Collection<String> attributeIds) throws SQLException {
    ...
    public static HashSet<String> getDistinctParameters(int cancerStudyId) throws SQLException {

        HashSet<String> toReturn = new HashSet<String>();
        for (ClinicalData clinicalData : MyDaoClinicalData.getData(cancerStudyId)) {
    ...
    public static HashSet<String> getAllPatients(int cancerStudyId) throws SQLException {
    ...
    public static List<ClinicalData> getDataByCancerStudy(int cancerStudyId) throws SQLException {

        return MyDaoClinicalData.getData(cancerStudyId);
    }

    public static List<ClinicalData> getDataByPatientIds(int cancerStudyId, List<String> patientIds) throws SQLException {

        return MyDaoClinicalData.getData(cancerStudyId, patientIds);
    }

    public static List<Patient> getPatientsByAttribute(int cancerStudy, String paramName, String paramValue) throws SQLException {
    ...
    public static List<Sample> getSamplesByAttribute(int cancerStudy, String paramName, String paramValue) throws SQLException {
        List<Integer> ids = getIdsByAttribute(cancerStudy, paramName, paramValue, SAMPLE_TABLE);
        return InternalIdUtil.getSamplesById(ids);
    }

    private static List<Integer> getIdsByAttribute(int cancerStudyId, String paramName, String paramValue, String tableName) throws SQLException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    // in one study
    public static Map<String, List<String>> getCancerTypeInfo(int studyID) throws SQLException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
