...
public final class MyExtendedMutation {
    ...
    public final static class MutationEvent {
        ...
        public String toString() {
            return "MutationEvent{" + "mutationEventId=" + mutationEventId + ", gene=" + gene + ", chr=" + chr + ", startPosition=" + startPosition + ", endPosition=" + endPosition + ", proteinChange=" + proteinChange + ", mutationType=" + mutationType + ", functionalImpactScore=" + functionalImpactScore + ", fisValue=" + fisValue + ", linkXVar=" + linkXVar + ", linkPdb=" + linkPdb + ", linkMsa=" + linkMsa + ", keyword=" + keyword + ", ncbiBuild=" + ncbiBuild + ", strand=" + strand + ", variantType=" + variantType + ", referenceAllele=" + referenceAllele + ", tumorSeqAllele=" + tumorSeqAllele + ", dbSnpRs=" + dbSnpRs + ", dbSnpValStatus=" + dbSnpValStatus + ", oncotatorDbSnpRs=" + oncotatorDbSnpRs + ", oncotatorRefseqMrnaId=" + oncotatorRefseqMrnaId + ", oncotatorUniprotName=" + oncotatorUniprotName + ", oncotatorUniprotAccession=" + oncotatorUniprotAccession + ", oncotatorCodonChange=" + oncotatorCodonChange + ", oncotatorProteinPosStart=" + oncotatorProteinPosStart + ", oncotatorProteinPosEnd=" + oncotatorProteinPosEnd + ", canonicalTranscript=" + canonicalTranscript + '}';
        }
    }
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        final MyExtendedMutation other = (MyExtendedMutation) obj;
