 ...
 * @author mcaikovs
 */
public class MyImportValWithClinicalDataDivideInTwoParts extends  MyImportValWithClinicalData{

    MyProperties p;

    public MyImportValWithClinicalDataDivideInTwoParts()   {
    ...
    public static String RRO_STUDY_NAME = "aca_chuv_val3";

    // static String SOURCE_FILE_DIR = "C:\\Projects\\cBioPortal\\data sample\\test\\";
    public static void main(String... args) throws Exception {
        new CleanStudy().clean(RRO_STUDY_NAME);
        new MyImportValWithClinicalDataDivideInTwoParts().runImport(RRO_FILE_PATH);
    }
}
